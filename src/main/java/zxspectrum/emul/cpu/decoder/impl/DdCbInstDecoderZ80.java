...
@Slf4j
final class DdCbInstDecoderZ80 extends BaseInstDecoderZ80 implements Const {
    private final Counter tStatesRemains;

    DdCbInstDecoderZ80(@NonNull Cpu cpu, @NonNull final Counter tStatesRemains, @NonNull LdIO ldIO
